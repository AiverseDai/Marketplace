...
contract Auction is IERC721Receiver{
    ...
    function createSaleAuction(uint256 _tokenId,uint256 _price,address _tokenaddress)public returns(uint256){
    ...
    function fixedSale(uint256 _tokenId,uint256 _price,address _tokenaddress) public{
         require(TokenX.ownerOf(_tokenId) == msg.sender,"Auction your NFT");
