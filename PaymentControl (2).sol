...
// Defining function to make payment
    function Pay() onlyBuyer instate(
	State.awate_payment) public payable{
		
	}
	
	// Defining function to confirm payment
	function confirm_payment() onlyArbitr instate(
	State.awate_payment) public {
    ...
    function ResetState () onlyArbitr  public {
        state = State.awate_payment;
